...
var connectionString = builder.Configuration["DBConnection"];// pour heroku
if (string.IsNullOrWhiteSpace(connectionString)) connectionString = builder.Configuration.GetConnectionString("DBConnection");
